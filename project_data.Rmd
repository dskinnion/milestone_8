...
# To investigate the data by year, I arranged by year.
# I don't think I ended up using this data frame, but it was
# useful for me to go in and look at the data to make sure
# that everything worked the way I expected it to.
...
# This was a test graphic to make sure that my data frame
# returned the values that I was expecting, just for 2016.
# This was the basis for my interactive graphic in my shiny app.
...
# This was also a test graphic to make sure that the data
# makes sense. The population and ev_density for each state
# should be inversely proportional, and the linearity of this
# scatter plot confirmed that.
...
# I then wanted to test out a function that I would use for my interactive piece
# for my shiny_app.
# This is essentially the same code as the function for the graphic for 2016
# that I made above, but that accepts an input of vectors.
...
# I was going to use the plots and write_rds() to move them to my shiny_app,
# but I couldn't get it to work. Shivani said I could come to her next study hall
# for help, which is why I left it here.
...
# This was the regression model that I was attempting to make
# with Georgie. Using lm, we calculated the ev_density as a function
# of being Republican and the year, to see if Republicans get an 
# advantage in the electoral college, and if there was a trend over time.
# I have kept this here so that I can further discuss with Georgie.
...
# Also part of the regression with Georgie. We fitted
# predicted values which we then plotted in the next code chunk.
# Again, I have kept this here so that I could further discuss with her.
...
# A plot of the regressions I made with Georgie.
# I couldn't tell the difference between R and D so I color coded them.
...
# This was a test graphic to see if the total number of electoral
# votes and the proportions worked.
...
# These were test graphics to see if there were possible 
# trends across time (and it looks like there weren't)
# I wanted to see the popular winner and the electoral winner,
# which were the same in all but 2 cases
...
# This is essentially the same as the graphs above, but by loser
# not winner, because I wanted to see if that was any different.
...
# Animated version of the interactive graphic, but I could not
# get the bars to reorder in each frame.
