...
#   group_by(year) %>%
#   summarize()
#   mutate(popular_winner = ifelse(popular_proportion > 0.5, "yes", "no"))
# 
# dems <- modern_popular_winner %>%
#   filter(Party == "Democratic")
# 
# reps <- modern_popular_winner %>%
...
plot_1932 <- evd_plots[1]
write_rds(plot_1932, path = "graphics/plot_1932.rds")

plot_1932 <- evd_plots[2]
plot_1932 <- evd_plots[3]
plot_1932 <- evd_plots[4]
plot_1932 <- evd_plots[5]
evd_plots[6]
evd_plots[7]
evd_plots[8]
evd_plots[9]
